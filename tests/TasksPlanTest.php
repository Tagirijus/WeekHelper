...
final class TasksPlanTest extends TestCase
{
    ...
    public function testDailyLimits()
    {
    ...
    public function testDailyLimitsPerDay()
    {
        $tasks_plan = new TasksPlan();
    ...
    public function testRemainingMinutes()
    {
        $tasks_plan = new TasksPlan();
    ...
    public function testRemainingMinutesMaxFromTask()
    {
        $tasks_plan = new TasksPlan();
